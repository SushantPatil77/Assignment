...
class CabBookingApplicationTests {
   ...
   @Autowired
    TripBookingserviceimpl tripbookingimpl; //object of tripbookingimpl
   @Autowired
	public AdminRepository adminRepository;//object of adminRepo
   @Autowired
   Tripbookingrepo tripbookingrepo;//object of  tripbookingrepo
   @Autowired
    DriverRepository driverRepository;//object of driverRepository
	@Test
	void contextLoads() {
